...
import { ArrowLeft, Globe, Landmark, Building2, Home, AlertTriangle, GitBranch, FileText, Loader2, Info, Network } from 'lucide-react';
        ...
        {levels.map((level) => {
          ...
          return (
            <div key={level.key} className="bg-white rounded-xl shadow-md overflow-hidden dark:bg-gray-800">
              <div className={`px-5 py-3 bg-gradient-to-r ${LEVEL_COLORS[level.key]} flex items-center justify-between`}>
